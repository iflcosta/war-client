local statsWindow, statsButton, luaStats, luaCallback, mainStats, dispatcherStats, render, atlas, adaptiveRender, slowMain, slowRender, widgetsInfo, packets, slowPackets, updateEvent, monitorEvent = nil
local iter = 0
local lastSend = 0
