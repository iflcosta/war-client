local topMenu, fpsUpdateEvent, statusUpdateEvent = nil
...
function updateStatus()
	...
	if not Services or not Services.status or Services.status:len() < 4 then
		return
	end

	if not topMenu.onlineLabel then
		return
	end
