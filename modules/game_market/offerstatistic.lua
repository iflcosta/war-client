OfferStatistic = {
	__index = OfferStatistic
}
SECONDS_PER_DAY = 86400

function OfferStatistic.new(timestamp, t, transactions, totalPrice, highestPrice, lowestPrice)
	local stat = {
		lowestPrice = 0,
		highestPrice = 0,
		totalPrice = 0,
		transactions = 0,
		time = 0,
		time = math.floor(timestamp / SECONDS_PER_DAY) * SECONDS_PER_DAY
	}
